...
const LOGGER_CONSOLE = config.get('logger.console') === true || config.get('logger.console') === 'true';
...
// only one instance to be registered
if (LOGGER_CONSOLE) {
  transports.push(new winston.transports.Console());
} else if (PAPERTRAIL_HOST && PAPERTRAIL_PORT) {
